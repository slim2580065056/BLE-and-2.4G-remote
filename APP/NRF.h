...
#define RD_RX_PLOAD     0x61  //读RX有效数据,1~32字节,当读数据完成后,数据被清除,应用于接收模式
#define WR_TX_PLOAD     0xA0  //写TX有效数据,1~32字节,写操作从0开始,应用于发送模式
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//24L01操作线
#define NRF_CE			PAout(11) //24L01片选信号
#define NRF_CSN			PBout(12) //SPI片选信号	 
#define NRF_IRQ			PAin(8)  //IRQ主机数据输入
//24L01发送接收数据宽度定义
